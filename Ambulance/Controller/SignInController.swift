...
class SignInController: UIViewController,UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        setupViews()
       // PasswordTextField.rightView = rightButtonToggle
    ...
    let rightButtonToggle: UIButton = {
        ...
        rightButton.setBackgroundImage(UIImage(named: "visibleICON"), for: .normal)
    ...
    @objc func PasswordTogglekButtonAction(){
        if(iconClick == false) {
            ...
            rightButtonToggle.setBackgroundImage(UIImage(named: "visibleICON"), for: .normal)
        } else {
            PasswordTextField.isSecureTextEntry = true
             rightButtonToggle.setBackgroundImage(UIImage(named: "invisibleICON"), for: .normal)
        }
    ...
    @objc func SignInButtonAction(sender: UIButton!) {
        print("SignInButton tapped 11111111111")
