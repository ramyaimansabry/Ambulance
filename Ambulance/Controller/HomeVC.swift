  ...
  let locationManager = CLLocationManager()
    ...
    func checkLocationAuthorization(){
        ...
        case .authorizedWhenInUse:
            ...
            break
        case .denied:
            ShowErrorAlert(Title: "Oops!", Message: "Location denied!, Check location permission")
            break
        case .notDetermined:
            locationManager.requestWhenInUseAuthorization()
            break
        case .restricted:
            ShowErrorAlert(Title: "Oops!", Message: "Location restricted!, Check location permission")
            break
        }
    }
    ...
    func locationManager(_ manager: CLLocationManager, didFailWithError error: Error) {
        checkLocationAuthorization()
        ShowErrorAlert(Title: "Oops!", Message: "Location Unavailable!")
    ...
    // if any one accept the emergency .. show fourth view
    ...
    @objc func CallAmbulanceButtonAction(sender: UIButton!) {
        print("****** CallAmbulanceButton tapped* *****")
